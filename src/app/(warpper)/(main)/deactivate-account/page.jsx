        ...
        <div className="edit-profile-container">
            <div className="edit-profile-wrapper">
                <div className="page-header">
                    ...
                    <span className="page-name">Deactivate Account</span>
                </div>
                        ...
                        <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                            {warningItems.map((item, index) => (
                                <li key={index} style={{
                                    ...
                                    <i className="fas fa-info-circle" style={{ marginTop: "0.25rem" }}></i>
                ...
                <div className="profile-card">
                    <div className="card-header">
                        <h2 className="card-title">
                            <i className="fas fa-user-slash" style={{ marginRight: "0.5rem" }}></i>
                    ...
                    <div className="card-content">
                        ...
                        <div style={{
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                                ...
                                <div>
                                    <div style={{ fontWeight: "600", fontSize: "0.875rem" }}>Important Notice</div>
