...
export default function ProfileSettings() {
  const { user: authUser, updateUser, setUser } = useAuth();
    ...
    const fetchUserData = async () => {
      try {
        ...
        const res = await apiFetch(
          `/api/get-user?user_id=${authUser?.user_id}`,
        );
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (res.status) {
        ...
        const userProfile = await apiFetch("/api/profile");
    ...
    <div className="edit-profile-container">
      <div className="edit-profile-wrapper">
        <div className="page-header">
          ...
          <span className="page-name">Edit Profile</span>
        </div>
                  ...
                  <Image
                    src={
                      profileData.coverImage?.startsWith("blob:")
                        ? profileData.coverImage
                        : `/api/images?url=${profileData.coverImage}`
                    }
                    alt="Cover"
