...
const ChangeEmail = ({ onBack }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('✅ Email change request submitted! Please check your current email for verification.');
        ...
        <div className="change-email-header">
          ...
          <div className="header-content">
            ...
            <p className="page-subtitle">
              Update your email address. You'll receive verification links on both emails.
            </p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="email-form">
            ...
            <div className="form-section new-email-section">
              ...
              <div className="form-group">
                ...
                {errors.newEmail && (
                  <p className="error-message">
                    <i className="fas fa-exclamation-circle"></i> {errors.newEmail}
                  </p>
                )}
              </div>
              ...
              <div className="form-group">
                ...
                {errors.confirmEmail && (
                  <p className="error-message">
                    <i className="fas fa-exclamation-circle"></i> {errors.confirmEmail}
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="security-notice">
              ...
              <div className="notice-content">
                ...
                <ul className="notice-list">
                  <li>A verification link will be sent to your current email</li>
                  <li>Another verification link will be sent to your new email</li>
            ...
            <div className="form-actions">
              ...
              <button
                ...
                disabled={isLoading || !emailData.newEmail || !emailData.confirmEmail || !emailData.password}
              >
                {isLoading ? (
                  <>
