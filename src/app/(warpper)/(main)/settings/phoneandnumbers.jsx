...
const PhoneNumberandBirthday = ({ onBack }) => { 
  ...
  const privacyOptions = [
    {
      ...
      value: 'Public',
      icon: 'fas fa-globe',
      description: 'Anyone on or off the platform can see'
    },
    {
      id: 'friends',
      value: 'Friends',
    ...
    },
    {
      ...
      value: 'Only me',
      icon: 'fas fa-lock',
      description: 'Only you can see- completely private'
    }
  ];

  // Load saved setting on component mount
  useEffect(() => {
    const savedSetting = localStorage.getItem('phoneBirthdayVisibility') || 'Friends'; // Change key
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Save with a different key for phone/birthday
      localStorage.setItem('phoneBirthdayVisibility', selectedOption);
      ...
      <div className="who-can-see-posts-container">
        ...
        <div className="who-can-see-posts-header">
          ...
          <div className="header-content">
            <h1 className="page-title">Who Can See My Phone Number and Birthday</h1>
            <p className="page-subtitle">
              Control who can view your phone number and birthday.
            </p>
          </div>
        </div>
              ...
              <div className="current-setting-display">
                <div className="setting-info">
                  ...
                  <div className="setting-details">
                    <p className="setting-label">Your phone number & birthday are currently visible to</p> {/* Updated text */}
...
export default PhoneNumberandBirthday; 