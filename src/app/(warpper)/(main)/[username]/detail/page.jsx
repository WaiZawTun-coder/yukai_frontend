    ...
    return (
        <div className="user-detail-container">
            ...
            <div className="user-card header-card">
                <Image
                    src={user.profile_image ? `/api/images?url=${user.profile_image}` : `/Images/default-profiles/${user.gender}.jpg`}
                    alt="Profile"
            ...
            <div className="user-card info-card">
                ...
                {user.birthday && (
                    <div className="info-row">
                        <span>Birthday</span>
                        <span>
                            {new Date(user.birthday).toDateString()} ({calculateAge(user.birthday)} yrs)
                        </span>
                    </div>
                )}
            ...
            <Popup
                ...
                footer={
                    <div className="popup-actions">
                        <button onClick={() => setBlockPopupOpen(false)} className="popup-btn popup-btn-cancel">Cancel</button>
                        <button onClick={handleBlockUser} className="popup-btn popup-btn-danger">
                            Block
                        </button>
                    </div>
                }
            ...
            <Popup
                ...
                footer={
                    <div className="popup-actions">
                        <button onClick={() => setReportPopupOpen(false)} className="popup-btn popup-btn-cancel">Cancel</button>
                        <button onClick={handleReportUser} className="popup-btn popup-btn-danger">
                            Report
                        </button>
                    </div>
                }
